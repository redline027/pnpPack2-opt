function [ Rest, test, fest, retVal] = pnpNd1204_orig( C, V, D, tarPtNum, testvec, fans, N, stopN, pts, isFast, haveMex)    
    doTimeMes = 0;
...
%         if (1)
    ...
    [R, t, f, candsBest] = vote_orig(cands, BP, C, resCosts, tarPtNum, pts);
